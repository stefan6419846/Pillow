...
from . import Image, ImageFile, PyAccess
...
def _accept(prefix: bytes) -> str | bool | None:
...
def _save_all(im: Image.Image, fp: BytesIO, filename: str) -> None:
    ...
    background: list[int] | tuple[int, ...] | int = (0, 0, 0, 0)
