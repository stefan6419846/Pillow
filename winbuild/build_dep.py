...
""" + vc_setup(compiler, bit) + r"""
echo "lcms71 a"
copy /Y /B "C:\Program Files (x86)\MSBuild\\12.0\Bin\amd64\Microsoft.Build.Tasks.Core.dll" "C:\Program Files (x86)\MSBuild\\14.0\bin\amd64\Microsoft.Build.Tasks.Core.dll"
copy /Y /B "C:\Program Files (x86)\MSBuild\\12.0\Bin\amd64\Microsoft.Build.Tasks.v12.0.dll" "C:\Program Files (x86)\MSBuild\\14.0\bin\amd64\Microsoft.Build.Tasks.v12.0.dll"
